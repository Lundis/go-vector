...
func TestIsZero(t *testing.T) {
	assert.Equal(t, New(0, 0).IsZero(), true)
	assert.Equal(t, New(0.000001, 0.000001).IsZero(), false)
	assert.Equal(t, New(1, 0).IsZero(), false)
	assert.Equal(t, New(0, 1).IsZero(), false)
}
